...
The callback routes are generated by INPROFIC during transaction initialization. Founder Console retains manual confirmation as an operational fallback for legacy/manual payment requests; online Paystack/Monnify payments should normally be confirmed automatically.
